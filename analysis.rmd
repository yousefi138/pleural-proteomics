---
title: "`r tools::toTitleCase(project)` proteomics of pleural infection"
...
Of the **`r project`** samples run, `r ncol(prot.mat)` passed the default qc performed in the `metaboprep` package.

For the moment, all `r nrow(prot.mat)` measured proteins have been retained for analysis.

See `r paste0(project, "metaboprep_qc_report.html")` for full details.
...
Phenotypic characteristics of participants described in [Phenotype information](#phenotype-information) were examined for association with protein abundances ([Protein measurements](#protein-measurements))
